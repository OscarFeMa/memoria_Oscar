...
// Configuración para producción - SQLite
const dbPath = process.env.DATABASE_URL || 
  (process.env.NODE_ENV === "production" ? "/tmp/memoria.db" : "../database/memoria.db");
...
// INICIAR SERVIDOR
app.listen(PORT, () => {
    console.log("🌐 MEMORIA OSCAR WEB - PRODUCCIÓN ACTIVA (SQLite)");
